        ...
        <div class="overflow-x-auto">
          <form @submit.prevent="submit" class="space-y-4">
            ...
            <div>
              ...
              <input v-model="store.student.year" type="number" id="year"
                     class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"/>
            </div>
            <div>
            ...
            <div>
              ...
              <select v-model="store.student.branch!.id" id="branch"
                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            ...
            <div>
              ...
              <select v-model="store.student.student_category!.id" id="category"
                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
